  ...
  questions: [
    {
      ...
      helper: "This is how you would like your business name displayed across all of your online profiles, so please ensure it is written EXACTLY how you would like it to be including the use of capital letters..",
      group: [
        { id: "company_name", type: "text", title: "Company name", required: true, width: "half", leadingIcon: "building" },
        {
          id: "business_email",
          type: "email",
    ...
    },
    {
      ...
      group: [
        { id: "first_name", type: "text", title: "First name", required: true, width: "half", leadingIcon: "user" },
        { id: "last_name", type: "text", title: "Last name", required: true, width: "half", leadingIcon: "user" },
      ],
    },
    {
      ...
      required: false,
      provideLater: { label: "I will provide later" },
    },
    {
      id: "company_address",
      type: "field-group",
      ...
      group: [
        { id: "street_address", type: "text", title: "Street address", required: true, leadingIcon: "pin" },
        { id: "city", type: "text", title: "City", required: true, width: "half", leadingIcon: "building" },
        { id: "country", type: "select", title: "Country", required: true, width: "half", options: COUNTRY_OPTIONS, leadingIcon: "globe" },
        { id: "state_region", type: "text", title: "State / region", width: "half", leadingIcon: "pin" },
        { id: "postal_code", type: "text", title: "Postal code", required: true, width: "half", leadingIcon: "tag" },
      ],
    },
    {
      ...
      required: true,
      yearRange: { from: 1970, to: 2026 },
      yearBeforeEarliestLabel: "Before 1970",
    },
    {
      id: "has_partners",
      type: "single-choice",
    ...
    },
    {
      ...
      groupItemLabel: "Colleague's or Partner's info",
      minItems: 1,
    ...
    },
    {
      ...
      required: true,
      singleChoiceTileImages: true,
      options: [
        { value: "1-4", label: "1 to 4", imageUrl: "/image/image/new-van.svg" },
        { value: "5-9", label: "5 to 9", imageUrl: "/image/image/new-van.svg" },
        { value: "10-plus", label: "10+", imageUrl: "/image/image/new-van.svg" },
        { value: "not-applicable", label: "Not Applicable", imageUrl: "/image/image/No.svg" },
      ],
    },
    {
      id: "van_picture",
    ...
    },
    {
      ...
      options: [
        opt("yes", "Yes"),
        opt("no", "No"),
        opt("i-ll-decide-later", "I'll decide later"),
      ],
    },
    {
      id: "finance_company",
      type: "single-choice",
      icon: "card",
      title: "Please select the finance company you use?",
      required: true,
      singleChoiceTileImages: true,
      otherTextAnswerId: "finance_company_name",
      visibleIf: { all: [{ questionId: "finance_options", equals: "yes" }] },
      options: [
        optImg("Kanda", "kanda-img.png"),
        optImg("Phoenix", "phoenix-img.png"),
        optImg("Humm", "humm-img.png"),
        optImg("kandoo", "kandoo.png"),
        optImg("Hometree Finance", "hometree.png"),
        optImg("Other", "other-img.png"),
      ],
    },
    {
      id: "business_scope",
      ...
      required: true,
      visibleIf: { all: [{ questionId: "finance_options", isAnswered: true }] },
    ...
    },
    {
      ...
      minItems: 1,
      group: [
        { id: "reason", type: "text", title: "Reason", required: true, leadingIcon: "star" },
        { id: "description", type: "text", title: "Description", required: true, leadingIcon: "type" },
      ],
    },
  ],
};
...
const branding: Section = {
  ...
  questions: [
    ...
    },
    {
      ...
      galleryMulti: true,
      galleryDescriptionAnswerId: "logo_style_description",
      galleryDescriptionPlaceholder: "Write Here",
    ...
    },
    {
      ...
      type: "textarea",
      icon: "image",
      title: "Could you tell us more about what you like and don't like about the logo design you chose?",
    ...
    },
    {
      ...
      type: "textarea",
      icon: "image",
      title: "Could you please provide more details about what you like or dislike in the mockup/template you have chosen?",
    ...
    },
    {
      ...
      type: "multi-choice",
      icon: "wrench",
      title: "Which services would you like to include on your new website? Start with your main service.Please list the services you’d like to include on your new website, starting with your main service.",
      required: true,
      options: [
    ...
    },
    {
      ...
      group: [
        { id: "offer", type: "text", title: "Offer", required: true, leadingIcon: "tag" },
    ...
    },
    {
      ...
      group: [
        { id: "feature", type: "text", title: "Feature", required: true, leadingIcon: "sparkles" },
    ...
    },
    {
      ...
      helper: "(eg. Facebook, Google, Trust Pilot etc)",
      required: true,
      options: YES_NO,
    },
    {
    ...
    },
    {
      ...
      type: "email",
      icon: "mail",
      title: "What email address do you want to display on your website? This address will receive your lead notifications.",
...
const ads: Section = {
  ...
  questions: [
    ...
    },
    {
      ...
      rows: 6,
      visibleIf: { all: [{ questionId: "tried_google_ads", equals: "no" }] },
    },
    {
...
const access: Section = {
  ...
  questions: [
    ...
    },
    {
      ...
      group: [
        { id: "person_name", type: "text", title: "Person name", required: true, width: "half", leadingIcon: "user" },
    ...
    },
    {
      ...
      group: [
        { id: "username", type: "text", title: "Username", required: true, width: "half", leadingIcon: "user" },
    ...
    },
    {
      ...
      visibleIf: {
        all: [{ questionId: "payment_methods", includes: "stripe" }],
      },
      options: YES_NO,
    },
    {
    ...
    },
    {
      ...
      group: [
        { id: "username", type: "text", title: "Username", width: "half", leadingIcon: "user" },
